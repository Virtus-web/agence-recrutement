...
//QUERY PARAMS POUR GERER LES RESULTS DONT LES REPONSES SONT ECRITS DANS L'URL//
...
function Results() {
    ...
    //Par convention on appelle ça queryParams (au lieu de spécifiquement fetchParams ici)
            ...
            <ResultsTitle theme={theme}>
                ...
                resultsData.map((result, index) => (
                    <JobTitle key={`result-title-${index}-${result.title}`} theme={theme}>
                        ...
                        {/* Adaptation du JSX pour tester la fonction formatJobList */}
